	          ...
	          <div class="collapse navbar-collapse" id="navbarSupportedContent">
	            ...
	            <c:choose>
	               <c:when test="${!empty sessionUser}">
	                  ...
	                  <a class="nav-link dropdown-toggle  mt-3" id="navbarDarkDropdownMenuLink" role="button"
	    ...
	    <!-- ------------------------------------------------------------- 2번째 navbar ----------------------------------------------------------------------- -->
	      ...
	      <nav class="navbar navbar-expand-lg" ><!-- class="navbar navbar-expand-lg navbar-dark bg-dark" -->
	         ...
	         <div class="container-fluid">
           		...
           		<div class="col">
           		 <a class="navbar-brand-md" id="mainLogo" href="../main/main.do" style="margin:0px;">
           			<img src="../resources/img/logo.png">
           			</a>
           		</div>

           		<div class="col">
		            <a class="navbar-brand-md" id="mainLogo" href="../main/main.do" style="margin:0px;font-size:35px;text-decoration-line:none;color:#004ba0;font-weight:bold;">
		 			ManGae
		            </a>
	            </div>
	            ...
	            <!--  div  class="container justify-content-center"-->
	               <ul class="navbar-nav" ><!--  navbar-center -->
	                    ...
	                    <li class="nav-item">
	                      <a class="nav-link" href="../lostdogboard/lostdogList.do" style="margin-left:0px;font-size: 20px;color:#333333 ;">단체소개</a>
	                    </li>

	                    <li class="nav-item">
	                      <a class="nav-link" href="#" style="font-size: 20px;color:#333333 ;">자유게시판</a>
	                    </li>

	                   	<li class="nav-item">
	                      <a class="nav-link" href="#" style="font-size: 20px;color:#333333 ;">힐링공간</a>
	                    </li>
